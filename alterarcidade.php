...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #03A331;">
	...
	if(isset($_GET['idcidade'])){
		...
		$resp=$student->buscaridcidade();  
		?>
		<h3 class="text-center">Alterar Cidade</h3>

		<div class="row justify-content-center">
		<form action="alterarcidade2.php" method="POST">
			...
			name="idestado"></p>
			<p>Quantos Funcionarios: </br> <input type="number"
			value="<?php echo $resp['quantosfuncionarios']?>"
			name="quantosfuncionarios"></p>
			<p>Quantos Alunos:</br> <input type="number" 
			value="<?php echo $resp['quantosalunos']?>"
			name="quantosalunos"></p>
